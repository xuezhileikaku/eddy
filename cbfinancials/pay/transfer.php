    ...
    <div>
        ...
        <form method="post" action="doTransfer.php" id="yeepay_form">
            <table>
                ...
                <tr>
                    <td></td>
                    <td colspan="3"><input type="button" id="doSubmit" value="转账" onclick="submitOrder()"><input type="reset" value="重置" onclick="$(&#39;#txt_Amount, #txt_Remark&#39;).val(&#39;&#39;)"><span><?php echo isset($_GET['error']) ? $_GET['error'] : '当前日期：'.date('Y-m-d'); ?></span></td>
                </tr>
            </tbody></table>
        </form>
