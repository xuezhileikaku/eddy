String.prototype.getCnLen = function() {
    return this.replace(/[^\x00-\xff]/g, "--").length;
};
String.prototype.getSame = function(num) {
    var tmpArr = [];
    for (var i = 0; i < num; i++)
        tmpArr.push(this);
    return tmpArr.join("");
...
String.prototype.getEnStr = function() {
    return this.replace(/[^A-Za-z]/g, "");
};
String.prototype.getCnStr = function() {
...
String.prototype.sub = function(n, ext) {
    ext = ext || '';
    var r = /[^\x00-\xff]/g;
...
String.prototype.template = function(o, f) {
    var s = this, patternExpr = /{([^{}]*)}/g;
...
String.prototype.isUrl = function() {
    return /^(http(s)?:\/\/)?[A-Za-z0-9]+\.[A-Za-z0-9]+[\/=\?%\-&_~`@[\]\':+!]*([^\"\"])*$/.test(this);
};
