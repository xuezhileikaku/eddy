            ...
            <form method="post" action="./pay/rujin.php" id="yeepay_form">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td class="tc">交易帐号：</td>
                            <td colspan="3"><input type="text" id="txt_username"
                                                   name="username" value="" /></td>
                        </tr>
                        <tr>
                            <td class="tc">登陆密码：</td>
                            <td colspan="3"><input type="password" id="txt_password"
                        ...
                        <tr>
                            <td></td>
                            <td colspan="3"><input type="button" id="doSubmit" value="登陆"
                                                   onclick="submitOrder();" /> <input type="reset" value="重置" /><span><?php echo isset($_GET['error']) ? $_GET['error'] : '当前日期：' . date('Y-m-d'); ?></span>
                            </td>
                        </tr>
                    </tbody>
                </table>
            </form>
            <a href="./index.php" class="link">刷新本页</a> <a
                href="http://kq1.cbfinancials.net/" class="link" title="免登陆验证在线入金">免登陆验证在线入金</a>
            <p class="attention">注意：为保证客户资金能即时准确到账，在线出入金及内部转账前需用您的交易帐号和密码进行登陆验证。</p>
            <p class="attention">
                1、如果您需要在线入金或是在线出金，请用待入金或待出金交易帐号登陆。<br /> 2、如果您需要内部转账，请用转出资金交易帐号登陆。
            </p>
        </div>
